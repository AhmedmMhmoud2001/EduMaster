...
exports.deleteUser = exports.getUserById = exports.getAllUsers = exports.updateUserProfile = void 0;
var User_1 = require("../models/User");
// ✅ Update Stage, Semester, Subject
var updateUserProfile = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, stage, semester, subject, userId, user, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, stage = _a.stage, semester = _a.semester, subject = _a.subject;
                userId = req.user.id;
                return [4 /*yield*/, User_1.default.findByIdAndUpdate(userId, { stage: stage, semester: semester, subject: subject }, { new: true })];
            case 1:
                user = _b.sent();
                if (!user)
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!user)
                    return [2 /*return*/, res.status(404).json({ message: "المستخدم غير موجود" })];
                return [2 /*return*/, res.status(200).json({ message: "تم حذف المستخدم بنجاح" })];
            case 2:
                error_4 = _a.sent();
